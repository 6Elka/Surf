//
//  SupportSecondCollectionCell.swift
//  SURF
//
...
//MARK: - SupportSecondCollectionCell
final class SupportSecondCollectionCell: UICollectionViewCell {
    
    static let reuseId = "Second"
