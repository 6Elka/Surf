//
//  KindProfessionCollectionCell.swift
//  SURF
//
...
//MARK: - KindProfessionCollectionCell
final class KindProfessionCollectionCell: UICollectionViewCell {
    
    static let reuseId = "Kind"
