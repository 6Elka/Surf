//
//  OtherDescriptionCollectionCell.swift
//  SURF
//
...
//MARK: - OtherDescriptionCollectionCell
final class OtherDescriptionCollectionCell: UICollectionViewCell {
    
    static let reuseId = "Other"
